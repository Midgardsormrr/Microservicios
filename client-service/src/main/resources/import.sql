INSERT INTO client (id, rut, name, email, birth_date, monthly_visit_count) VALUES (1, '12.345.678-9', 'Juan Pérez', 'juan.perez@example.com', '1985-03-10', 2);
INSERT INTO client (id, rut, name, email, birth_date, monthly_visit_count) VALUES (2, '11.223.344-5', 'María López', 'maria.lopez@example.com', '1990-07-21', 4);
INSERT INTO client (id, rut, name, email, birth_date, monthly_visit_count) VALUES (3, '22.334.556-7', 'Carlos Díaz', 'carlos.diaz@example.com', '1978-12-01', 1);
